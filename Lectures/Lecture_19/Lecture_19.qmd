---
title: |
    | Lecture 19 - Conflict, Trade, and Globalization
...
-   But there is overall benefit 

First issue - what about those producers?
...
-   Trade creates inequality - Sort of.
        ...
        - When trade is combined with bad domestic policies, the benefits can be poorly distributed. 
        - This leads to...
 
 
## Globalization issues: Distributional issues       
        
Trade works best when combined with domestic liberalization.^[Topalova. (2010). Factor Immobility and Regional Impacts of Trade Liberalization Evidence on Poverty from India. American Economic Journal. Applied Economics, 2(4), 1–41. https://doi.org/10.1257/app.2.4.1] 
...
- Increased production generally means increased economic activity
- Increased production can also mean more efficient technology
- The effect is complex and nonlinear with extremely low tech being extremely low polluting, early industrial tech being high polluting, and extremely high tech being low polluting

- [Carbon emissions per dollar of GDP are one example](https://en.wikipedia.org/wiki/List_of_countries_by_carbon_intensity_of_GDP)     
